...
def brightness_decrease(pixels, wait=0.005, step=1):
...
if __name__ == "__main__":
    ...
    appear_from_back(pixels, (0,255,0))
    brightness_decrease(pixels)
    #check the blue pixels
    appear_from_back(pixels, (255,0,0))
    brightness_decrease(pixels)
    #check the red pixels
    appear_from_back(pixels, (0,0,255))
    brightness_decrease(pixels)
